        ...
        // encrypt the message and send when click Send button
            ...
            public void onClick(View v) {
                ...
                if (recNumString.length() > 0 && secretKeyString.length() > 0
                    ...
                    if (myEncMsg.length()>0) {
                        Intent i = new Intent(getApplicationContext(), DisplaySMSActivity.class);
                        i.putExtra("originNum", recNumString);
                        i.putExtra("msgContent", myEncMsg);
                        startActivity(i);
                    }
                    finish();
                } else
